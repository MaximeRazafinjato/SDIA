...
namespace SDIA.Infrastructure.Data;
...
public class SDIADbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.ApplyConfigurationsFromAssembly(typeof(SDIADbContext).Assembly);
        ...
        modelBuilder.Entity<FormTemplate>().HasQueryFilter(e => !e.IsDeleted);
